...
if ( ! class_exists( 'travel_booking_agency_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class travel_booking_agency_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new travel_booking_agency_WPTT_WebFont_Loader( $url );
