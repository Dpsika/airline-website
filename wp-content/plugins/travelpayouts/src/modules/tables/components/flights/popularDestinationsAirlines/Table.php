...
class Table extends FlightsShortcodeModel
{
    ...
    public function gridColumns(): array
    {
        return ArrayHelper::mergeRecursive(parent::gridColumns(), [
            ColumnLabels::PLACE => [
                'label' => $this->getColumnLabel(ColumnLabels::PLACE),
            ...
            ColumnLabels::DIRECTION => [
                ...
                'locale' => $this->locale,
                'label' => $this->getColumnLabel(ColumnLabels::DIRECTION),
    ...
    {
        return [
            'airline' => AirlineNameFormatter::getInstance()->getAirlineName(strtoupper($this->airline), $this->locale),
        ];
    }
