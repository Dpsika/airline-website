...
abstract class HotelTableShortcodeModel extends TableShortcode
{
    ...
    public function gridColumns(): array
    {
        return [
            ColumnLabels::NAME => [
                'label' => $this->getColumnLabel(ColumnLabels::NAME),
            ],
            ColumnLabels::STARS => [
                'class'=> ColumnStarRating::class,
                'label' => $this->getColumnLabel(ColumnLabels::STARS),
            ],
            ColumnLabels::DISCOUNT => [
                'class'=> ColumnDiscount::class,
                'label' => $this->getColumnLabel(ColumnLabels::DISCOUNT),
            ],
            ColumnLabels::OLD_PRICE_AND_NEW_PRICE => [
                'label' => $this->getColumnLabel(ColumnLabels::OLD_PRICE_AND_NEW_PRICE),
            ],
            ColumnLabels::BUTTON => [
                'label' => $this->getColumnLabel(ColumnLabels::BUTTON),
                'visible' => !$this->section->getUseRowAsLink(),
            ],
            ColumnLabels::PRICE_PN => [
                'class'=> ColumnPrice::class,
                'label' => $this->getColumnLabel(ColumnLabels::PRICE_PN),
                'currency'=> $this->currency,
            ],
            ColumnLabels::OLD_PRICE_AND_DISCOUNT => [
                'label' => $this->getColumnLabel(ColumnLabels::OLD_PRICE_AND_DISCOUNT),
            ],
            ColumnLabels::DISTANCE => [
                'class'=> ColumnDistance::class,
                'label' => $this->getColumnLabel(ColumnLabels::DISTANCE),
                'locale'=> $this->locale,
            ],
            ColumnLabels::OLD_PRICE_PN => [
                'class'=> ColumnPrice::class,
                'label' => $this->getColumnLabel(ColumnLabels::OLD_PRICE_PN),
                'currency'=> $this->currency,
            ],
            ColumnLabels::RATING => [
                'class'=> ColumnRating::class,
                'label' => $this->getColumnLabel(ColumnLabels::RATING),
            ],
        ];
    }
