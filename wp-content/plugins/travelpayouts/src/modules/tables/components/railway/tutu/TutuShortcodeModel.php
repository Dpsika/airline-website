    ...
    public function gridColumns(): array
    {
        return [
            ColumnLabels::TRAIN => [
                ...
                'label' => $this->getColumnLabel(ColumnLabels::TRAIN),
            ],
            ColumnLabels::ROUTE => [
            ...
            ColumnLabels::DEPARTURE => [
                ...
                'label' => $this->getColumnLabel(ColumnLabels::DEPARTURE),
            ],
            ColumnLabels::ARRIVAL => [
                'class' => ColumnTime::class,
                'attribute' => 'arrivalDate',
                'compareAttribute'=> 'departureDate',
                'label' => $this->getColumnLabel(ColumnLabels::ARRIVAL),
            ],
            ColumnLabels::DEPARTURE_TIME => [
                'class' => ColumnTime::class,
                'attribute' => 'departureTime',
                'label' => $this->getColumnLabel(ColumnLabels::DEPARTURE_TIME),
            ],
            ColumnLabels::ARRIVAL_TIME => [
                'class' => ColumnTime::class,
                'attribute' => 'arrivalTime',
                'label' => $this->getColumnLabel(ColumnLabels::ARRIVAL_TIME),
            ],
            ColumnLabels::DURATION => [
                'class'=> ColumnDuration::class,
                'label' => $this->getColumnLabel(ColumnLabels::DURATION),
                'attribute'=> 'travelTimeInSeconds',
            ],
            ColumnLabels::PRICES => [
                'class' => ColumnPrice::class,
                'attribute' => 'categories',
                'label' => $this->getColumnLabel(ColumnLabels::PRICES),
            ],
            ColumnLabels::DATES => [
                ...
                'label' => $this->getColumnLabel(ColumnLabels::DATES),
            ...
            ColumnLabels::ORIGIN => [
                ...
                'label' => $this->getColumnLabel(ColumnLabels::ORIGIN),
            ],
            ColumnLabels::DESTINATION => [
                'class'=> ColumnStation::class,
                'attribute'=> 'arrivalStation',
                'label' => $this->getColumnLabel(ColumnLabels::DESTINATION),
            ],
            ColumnLabels::ROUTE_FIRST_STATION => [
                'class'=> ColumnStation::class,
                'attribute'=> 'runDepartureStation',
                'label' => $this->getColumnLabel(ColumnLabels::ROUTE_FIRST_STATION),
            ],
            ColumnLabels::ROUTE_LAST_STATION => [
                'class'=> ColumnStation::class,
                'attribute'=> 'runArrivalStation',
                'label' => $this->getColumnLabel(ColumnLabels::ROUTE_LAST_STATION),
            ],
        ];
    }
