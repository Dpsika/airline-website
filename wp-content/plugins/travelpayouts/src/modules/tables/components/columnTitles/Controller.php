...
class Controller extends BaseController
{
    ...
    public function actionTranslationPhrases()
    {
        ...
        if ($localeId) {
            ...
            if (isset($supportedLocales[$localeId])) {
                $this->response(true, [
                    [
                        'label' => Travelpayouts::__('Flights column titles'),
    ...
    public function actionGetData()
    {
        $this->response(true,
            [
                ...
                'translatedPhrases' => $this->section->getTranslationStrings(),
    ...
    {
        return [
            'locale_select.title' => Travelpayouts::_x('Select which column titles language you want to customize', 'tables.columnTitles'),
